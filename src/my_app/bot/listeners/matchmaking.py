...
async def listen_matches(bot: Bot, storage: BaseStorage) -> None:
    ...
    async with channel_pool.acquire() as channel:
        ...
        async with user_queue.iterator() as user_queue_iter:
            async for message in user_queue_iter:
                await process_match_message(bot, storage, message)


async def process_match_message(bot: Bot, storage: BaseStorage, message: AbstractIncomingMessage) -> None:
