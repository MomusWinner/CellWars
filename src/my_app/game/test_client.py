...
from my_app.shared.rabbit.game import GAME_INFO_QUEUE, GAME_QUEUE, GAME_EXCHANGE
...
from my_app.shared.game.game_logic.command import BuildBank, BuyWarriorsCommand, MoveWarriorsCommand
...
async def run():
    ...
    command2 = {"command_name": "BUY_WARRIORS", "position":  {"x":1, "y":1}, "user_id":user_id2, "count": 10}
